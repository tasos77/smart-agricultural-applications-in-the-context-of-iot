    ...
    <div>
        ...
        <div class="notificationContainer">
            <v-slide-y-transition group>
                <VAlert v-if="alarmList.length !== 0" v-for="(alarm, index) in alarmList" :key="index" border="start"
                    prominent density="compact" type="warning" :title="alarm.alarmTitle" :text="alarm.alarmText"
                    class="mt-10 mr-3"></VAlert>
